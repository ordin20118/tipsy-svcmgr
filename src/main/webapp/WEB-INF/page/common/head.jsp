...
<head>
	...
	<link href="${path}/css/gwang.css" rel="stylesheet">
	<!-- Bootstrap core CSS -->
	...
	<!-- js -->
	<script type="text/javascript" src="${path}/js/common_ui.js"></script>
	<script type="text/javascript" src="${path}/js/common_ui_lib.js"></script>
